...
train_dirs = glob.glob("./dataset/letter_folders/*")
...
checkpoint = ModelCheckpoint(filepath="seq_letter_model.h5",
                             monitor="val_acc",
                             verbose=1,
                             save_best_only=True)
...
plt.savefig("letter_training_plot.png")

model.load_weights("seq_letter_model.h5")
model.save('seq_letter_model')
